...
<div class="container-lg my-3 col-xs-12 col-sm-10 col-md-8 col-lg-8 col-xl-8">
    ...
    <div class="justify-content-center d-flex mb-3">
        <img src="{{ old('foto')}}" class="card-img-top h-50 w-50" alt="{{ old('marca')}} {{ old('modelo') }} {{ old('color') }}">
    </div>
        ...
        <table class="table table-striped rounded-2 bg-white">
            ...
            <tr class="table-row  text-center align-middle">
                ...
                <td>
                    ...
                    @if (DB::table('producto_categorias')->where('fk_producto_id', '=', old('id'))->where('fk_categoria_id', '=', $categoria->id)->exists())
    ...
    <div class="d-flex justify-content-center">
        <form action="{{ route('addToCarrito') }}" method="POST">
            ...
            <input type="number" value="{{ old('cantidad') }}" name="cantidad"></input>
    ...
    ->where('favorito_productos.fk_producto_id', '=', old('id') )
    ...
    <div class="d-flex justify-content-center mt-3">
        <form action="{{ route('eliminarFavorito') }}" method="POST">
            @csrf
            @method('DELETE')
            <input type="hidden" name="idf" value="{{  old('id') }}">
            <button class="buttonP btn btn-danger btn-block" type="submit">
