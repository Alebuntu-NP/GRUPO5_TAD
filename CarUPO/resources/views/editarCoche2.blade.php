...
<div class="container-lg my-3 col-xs-12 col-sm-10 col-md-6 col-lg-4 col-xl-4">
    <div class="justify-content-center d-flex mb-3">
        <h1>{{ __('messages.editar') }} {{ old('marca') }} {{ old('modelo') }}</h1>
    </div>
    <form action="{{ route('editar.coche') }}" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" required name="marca" value="{{ old('marca') }}" placeholder="{{ __('messages.marca') }}" class="form-control mb-2" autofocus>
        @if ($errors->has('marca'))
        ...
        <input type="text" required name="modelo" value="{{ old('modelo') }}" placeholder="{{ __('messages.modelo') }}" value="" class="form-control mb-2">
        ...
        <input type="text" required name="color" value="{{ old('color') }}" placeholder="{{ __('messages.color') }}" class="form-control mb-2">
        @if ($errors->has('color'))
        <div class="alert alert-danger">
            {{ $errors->first('color') }}
        </div>
        ...
        <input type="text" required name="combustible" value="{{ old('combustible') }}" placeholder="{{ __('messages.combustible') }}" class="form-control mb-2">
        ...
        <input type="number" required name="cilindrada" value="{{ old('cilindrada') }}" placeholder="{{ __('messages.cilindrada') }}" step="0.01" class="form-control mb-2">
        ...
        <input type="number" required name="potencia" value="{{ old('potencia') }}" placeholder="{{ __('messages.potencia') }}" step="0.01" class="form-control mb-2">
        ...
        <input type="number" required name="nPuertas" value="{{ old('nPuertas') }}" placeholder="{{ __('messages.nPuertas') }}" step="1" class="form-control mb-2">
        ...
        <div class="containerP">
            ...
            @if (DB::table('producto_categorias')->where('fk_producto_id', '=', old('idp'))->where('fk_categoria_id', '=', $categoria->id)->exists())
