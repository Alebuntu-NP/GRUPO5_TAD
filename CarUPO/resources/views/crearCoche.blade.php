...
<div class="container-lg my-3 col-xs-12 col-sm-10 col-md-6 col-lg-4 col-xl-4">
    ...
    <form action="{{ route('addCoche') }}" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" required name="marca" placeholder="{{ __('messages.marca') }}" class="form-control mb-2" autofocus>

        <label for="modelo" class="form-label">{{ __('messages.modelo') }}</label>
        <input type="text" required name="modelo" placeholder="{{ __('messages.modelo') }}" class="form-control mb-2">

        <label for="descripcion" class="form-label">{{ __('messages.descripcion') }}</label>
        <input type="text" required name="descripcion" placeholder="{{ __('messages.descripcion') }}" class="form-control mb-2">

        <label for="color" class="form-label">{{ __('messages.color') }}</label>
        <input type="text" required name="color" placeholder="{{ __('messages.color') }}" class="form-control mb-2">

        <label for="combustible" class="form-label">{{ __('messages.combustible') }}</label>
        <input type="text" required name="combustible" placeholder="{{ __('messages.combustible') }}" class="form-control mb-2">

        <label for="cilindrada" class="form-label">{{ __('messages.cilindrada') }}</label>
        <input type="number" required name="cilindrada" placeholder="{{ __('messages.cilindrada') }}" step="0.01" class="form-control mb-2">

        <label for="potencia" class="form-label">{{ __('messages.potencia') }}</label>
        <input type="number" required name="potencia" placeholder="{{ __('messages.potencia') }}" step="0.01" class="form-control mb-2">

        <label for="nPuertas" class="form-label">{{ __('messages.nPuertas') }}</label>
        <input type="number" required name="nPuertas" placeholder="{{ __('messages.nPuertas') }}" step="1" class="form-control mb-2">
